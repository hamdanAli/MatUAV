function getRigidBodiesfromMocap(~, event)
    ...
    for i=1:nrb
        ...
        positionNED(i).x=double(rb.z)
        positionNED(i).y=double(-rb.x) 
        positionNED(i).z=double(-rb.y)
...
%     Mav.setMocap.x=positionNED.x;
%     Mav.setMocap.y=positionNED.y;
%     Mav.setMocap.z=positionNED.z;
%     Mav.setMocap.qw=q_wxyz.w;
%     Mav.setMocap.qx=q_wxyz.x;
%     Mav.setMocap.qy=q_wxyz.y;
%     Mav.setMocap.qz=q_wxyz.z;
